...
<div class="wrapper row3" >
    <main class="hoc container clear" id="act">
        <form action="">
            <h1>Description de projet : </h1>
            <hr />

            <div class="form-group">
                <label for="nom_enquete">Nom du projet: </label><br/>
                <input type="text" class="form-control" id="nom_enquete" >
            </div>

            <div class="form-group">
                <label for="des_enquete">Donner une description du projet: </label><br/>
                <textarea class="form-control"></textarea>
            </div>

            <div class="form-group">
                <label for="parti_enquete">Nombre de participants: </label><br/>
                <input type="text" class="form-control" id="parti_enquete">
            </div>

            <div class="form-group">
                <label for="zone_enquete">Veuillez selectionner la zone touchee par votre intervention: </label><br/>
                <input type="text" class="form-control" id="zone_enquete" />
            </div>
            <div class="form-group">
                <label for="exampleInputFile">Charger une base de donnees des beneficiaires :</label>
                <input type="file" id="exampleInputFile">
            </div>
            <div class="form-group">
                <label for="exampleInputFile">Charger des images du projet :</label>
                <input type="file" id="exampleInputFile">
            </div>
